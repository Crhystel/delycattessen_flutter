...
class ProductDetailScreen extends StatefulWidget {
  ...
  const ProductDetailScreen({Key? key, required this.item, required this.onAdd}) : super(key: key);
...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
            ...
            Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Icon(Icons.fastfood, size: 100, color: AppColors.textGray),
                ),
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.item.description.isEmpty ? 'Carne a la parrilla, Queso, Lechuga, Tomate' : widget.item.description,
  ...
  Widget _buildIngredientChip(String label) {
    return Container(
      ...
      child: Text(
        label,
        style: const TextStyle(color: AppColors.textBlueChip, fontWeight: FontWeight.w600, fontSize: 12),
      ),
    );
  }
